...
import { Mic, Pause, Square, Upload, Trash2, Play } from "lucide-react";

export default function VoxaideDashboard() {
        ...
        <div className="w-full max-w-2xl">
          ...
          {recordingState === "idle" && (
            <div className="flex flex-col items-center gap-8">
              ...
              <p className="text-slate-600 text-lg font-light">Click to start recording</p>
            </div>
          )}
          ...
          {(recordingState === "recording" || recordingState === "paused") && (
            <div className="flex flex-col items-center gap-12">
              {/* Visual Indicator */}
              <div className="relative">
                <div className={`w-32 h-32 rounded-full bg-gradient-to-br from-slate-200 to-slate-300 flex items-center justify-center ${
