    ...
    >
      <div className="flex flex-col items-center gap-12">
        ...
        <div className="flex gap-3">
          <div className="w-3 h-3 bg-slate-100 rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
          <div className="w-3 h-3 bg-slate-300 rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
          <div className="w-3 h-3 bg-slate-100 rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
        </div>
      </div>
    </div>
  );
